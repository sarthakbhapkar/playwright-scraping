        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (!(resolvedHref && text !== '')) return [3 /*break*/, 6];
...
function scrapeFolder(page, folderLocator, navLocator, content) {
    return __awaiter(this, void 0, void 0, function () {
        var folderName, baseUrl, urlLink, subfolders, f, parent_1, _i, subfolders_1, subfolder, parent_2, root, root, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    subfolders = _a.sent();
                    if (!(subfolders.length === 0)) return [3 /*break*/, 11];
                ...
                case 11:
                    ...
                    _a.label = 12;
                case 12:
                    if (!(_i < subfolders_1.length)) return [3 /*break*/, 15];
                ...
                case 14:
                    ...
                    return [3 /*break*/, 12];
                case 15:
                    if (!(folders.length > 0)) return [3 /*break*/, 22];
                    folders.pop();
                    if (!(folders.length > 0)) return [3 /*break*/, 18];
                    parent_2 = navLocator
                        .locator('div[tabindex="0"]')
                ...
                case 17:
                    ...
                    return [3 /*break*/, 21];
                case 18:
                    root = navLocator.locator('div[tabindex="0"]:has-text("/ sidebar.root")').nth(0);
...
function scrapeNavigationLinks(page) {
    return __awaiter(this, void 0, void 0, function () {
        var content, baseUrl, navLocator, foldersInNav, folderCount, i, folder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    content = {};
                    baseUrl = page.url();
                    navLocator = page.locator('div.v-navigation-drawer__content');
                    foldersInNav = navLocator.locator('div[tabindex="0"]');
                    return [4 /*yield*/, foldersInNav.count()];
                case 1:
                    folderCount = _a.sent();
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (!(i < folderCount)) return [3 /*break*/, 7];
                    folder = foldersInNav.nth(i);
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var browser, context, page, scrapedData, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 11:
                error_2 = _a.sent();
                console.error("An error occurred during scraping:", error_2);
                return [3 /*break*/, 14];
